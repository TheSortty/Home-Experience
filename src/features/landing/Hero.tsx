  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-6 relative z-10 text-center w-full flex flex-col items-center">
        <div className="inline-block mb-4 px-3 py-1 rounded-full bg-blue-50 text-blue-600 text-xs font-bold tracking-widest uppercase animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-serif font-bold tracking-tight text-slate-900 mb-8 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          HOME <br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-400">Experience</span>
        </h1>
