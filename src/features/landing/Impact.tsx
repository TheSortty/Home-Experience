            ...
            <div className="container mx-auto px-6">
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center mb-32">
                    ...
                    <div className="relative aspect-video rounded-3xl overflow-hidden shadow-2xl">
                        <Image src="/images/impact/social.jpg" alt="Impacto Social" width={800} height={600} className="w-full h-full object-cover" />
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <div className="order-2 lg:order-1 relative aspect-video rounded-3xl overflow-hidden shadow-2xl">
                        ...
                        <div className="w-full h-full bg-slate-100 flex items-center justify-center relative">
                            <Image src="/images/impact/ecological.jpg" alt="Limpieza de ríos" width={800} height={600} className="w-full h-full object-cover" />
