  ...
  public: {
    Tables: {
      ...
      google_calendar_accounts: {
        ...
        Relationships: [
          {
            foreignKeyName: "google_calendar_accounts_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: true
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      import_staging_rows: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "import_staging_rows_created_profile_id_fkey"
          ...
          {
            foreignKeyName: "import_staging_rows_matched_profile_id_fkey"
      ...
      profile_intake: {
        ...
        Relationships: [
          {
            foreignKeyName: "profile_intake_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: true
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      profile_notes: {
        ...
        Relationships: [
          {
            foreignKeyName: "profile_notes_author_profile_id_fkey"
      ...
      profile_tags: {
        ...
        Relationships: [
          {
            foreignKeyName: "profile_tags_added_by_fkey"
            columns: ["added_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      course_id_of_lesson: { Args: { p_lesson_id: string }; Returns: string }
      course_id_of_module: { Args: { p_module_id: string }; Returns: string }
      ...
      is_creser_cycle_type: { Args: { p_type: string }; Returns: boolean }
      is_staff: { Args: never; Returns: boolean }
      is_staff_or_coach: { Args: never; Returns: boolean }
      move_enrollment_to_cycle: {
        Args: {
      ...
      my_course_ids: { Args: never; Returns: string[] }
      ...
      preview_enrollment_move: {
        Args: { p_enrollment_id: string; p_target_cycle_id: string }
        Returns: Json
      }
      recount_cycle_enrollments: {
        Args: { p_cycle_id: string }
        Returns: number
      }
