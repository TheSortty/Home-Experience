...
//
// Duplicado a propósito: existe idéntico en apps/campus. entregaDownloadHref()
// (packages/services) arma un path relativo, así que cada Worker que enlaza
// a un archivo necesita servir esta misma ruta desde su propio origin — acá
// porque el admin revisa entregas, en campus porque el alumno las sube/baja.
// Ambos bindean el mismo bucket R2 (ver wrangler.jsonc), así que no hay
// duplicación de datos, sólo de esta capa fina de la ruta.
//
...
import { getEntregasBucket } from '@home/services/entregasStorage';
